...
class cfgVehicles
{
	...
	class PDZ_DuffelBag_Base: DuffelBagSmall_ColorBase
	{
		scope=0;
		displayName="BaseClassGoAway";
		descriptionShort="";
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1,{"DZ\Characters\backpacks\data\DuffelBagSmall.rvmat"}},
						{0.69999999,{"DZ\Characters\backpacks\data\DuffelBagSmall.rvmat"}},
						{0.5,{"DZ\Characters\backpacks\data\DuffelBagSmall_damage.rvmat"}},
						{0.30000001,{"DZ\Characters\backpacks\data\DuffelBagSmall_damage.rvmat"}},
						{0,{"DZ\Characters\backpacks\data\DuffelBagSmall_destruct.rvmat"}}
					};
				};
			};
		};
